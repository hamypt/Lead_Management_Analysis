-- CREATE TABLES AND DEFINE FOREIGN KEYS
...
CREATE TABLE interactions (
  ...
  FOREIGN KEY (salesrep_id) REFERENCES sales_team(salesrep_id) ON DELETE SET NULL
);
...
CREATE TABLE lead_assignments (
  ...
  FOREIGN KEY (salesrep_id) REFERENCES sales_team(salesrep_id) ON DELETE CASCADE
); 
...
INSERT INTO leads VALUES 
    ...
    (102, 'Anni', 'Suuri', 'anni.suuri@hscentral.com', '1234567893', 'Highlands Central', 'Food and Beverages', 'FDB Conference 2023', 'contacted', '2023-05-02', '2024-05-10'),
    ...
    (106, 'Elias', 'Kallio', 'elias.kallio@swiftwares.com', '1234567897', 'SwiftWares', 'Technology', 'website', 'contacted', '2024-03-15', '2024-05-13'),
    ...
    (111, 'Mikael', 'Lindgren', 'mikael.lindgren@innovatech.com', '1234567902', 'InnovaTech Solutions', 'Technology', 'Cold Call', 'qualified', '2023-09-10', '2024-05-15'),
    ...
    (114, 'Aino', 'Korpela', 'aino.korpela@sunshinetechnologies.com', '1234567905', 'Sunshine Technologies', 'Technology', 'Website', 'contacted', '2024-01-02', '2024-05-10'),
    ...
    (117, 'Niklas', 'Koski', 'niklas.koski@advantech.com', '1234567908', 'Advantech Solutions', 'Technology', 'Cold Call', 'contacted', '2023-10-20', '2024-05-10'),
    ...
    (127, 'Lauri', 'Mäkelä', 'lauri.makela@bigdatacorp.com', '1234567918', 'Big Data Corp.', 'Technology', 'Cold Call', 'new', '2024-02-10', '2024-05-12'),
    (128, 'Emmi', 'Koskela', 'emmi.koskela@analyticsteam.com', '1234567919', 'Analytics Team Ltd.', 'Technology', 'Website', 'new', '2024-04-05', '2024-05-12'),
    ...
    (130, 'Nea', 'Tiainen', 'nea.tiainen@innovativecorp.com', '1234567921', 'Innovative Corp.', 'Technology', 'Website', 'new', '2024-03-15', '2024-05-12'),
    (131, 'Akseli', 'Salmi', 'akseli.salmi@infosol.com', '1234567922', 'InfoSolutions Ltd.', 'Technology', 'Cold Call', 'contacted', '2023-09-20', '2024-05-10'),
    ...
    (134, 'Emma', 'Andersson', 'emma.andersson@acmecompany.com', '1234567925', 'ACME Company', 'Retail', 'Website', 'new', '2024-03-15', '2024-05-10'),
    ...
    (139, 'Liam', 'Persson', 'liam.persson@globalbizinc.com', '1234567930', 'Global Biz Inc.', 'Finance', 'Cold Call', 'contacted', '2024-04-12', '2024-05-11'),
    ...
    (141, 'Noah', 'Larsson', 'noah.larsson@smarttechcorp.com', '1234567932', 'Smart Tech Corp.', 'Technology', 'Website', 'qualified', '2024-04-02', '2024-05-13'),
    ...
    (144, 'Alice', 'Berg', 'alice.berg@logisticsgroup.com', '1234567935', 'Logistics Group', 'Logistics', 'Cold Call', 'contacted', '2024-04-18', '2024-05-10'),
    ...
    (149, 'Emil', 'Virtanen', 'emil.virtanen@healthcaregroup.com', '1234567940', 'Healthcare Group', 'Healthcare', 'Cold Call', 'lost', '2023-12-05', '2024-05-16'),
...
INSERT INTO opportunities VALUES
    (1, 103, 'PXT400T', 400000, 'qualification'),
    (2, 104, 'PMR2500', 500000, 'negotiation'),
    (3, 109, 'PXT400H', 500000, 'negotiation'),
    (4, 111, 'PMR70i', 450000, 'qualification'),
    (5, 113, 'PMR70i', 400000, 'prospecting'),
    (6, 115, 'PMR2500', 350000, 'closed'),
    (7, 118, 'PXT400H', 200000, 'prospecting'),
    (8, 124, 'PXT400T', 650000, 'qualification'),
    (9, 125, 'PMR2500', 480000, 'closed'),
    (10, 129, 'PMR70i', 200000, 'qualification'),
    (11, 132, 'PXT80i', 650000, 'proposal'),
    (12, 135, 'PMR2500', 300000, 'prospecting'),
    (13, 136, 'PMR70i', 370000, 'closed'),
    (14, 138, 'PMR2500', 400000, 'qualification'),
    (15, 141, 'PMR2500', 300000, 'qualification'),
    (16, 145, 'PXT400H', 200000, 'prospecting'),
    (17, 151, 'PXT80i', 550000, 'qualification'),
    (18, 154, 'PMR70i', 300000, 'prospecting'),
    (19, 120, 'PMR2500', 600000, 'prospecting'),
    (20, 123, 'PXT400T', 400000, 'prospecting')
;

-- ----------------------------------------------------------------------
-- UPDATE TABLES: Duplicate table 'leads' and update data in the new table 'leads_db' for more efficient analyses while keeping the original data unchanged in 'leads'

CREATE TABLE leads_db AS
SELECT * FROM leads;

UPDATE leads_db
SET lead_source = 'event'
WHERE lead_source = 'trade show' OR lead_source = 'CDC Conference 2024' 
OR lead_source = 'FDB Conference 2023' OR lead_source = 'Tech Expo 2024' 
OR lead_source = 'Medical Conference 2024' OR lead_source = 'Tech Expo 2023' 
OR lead_source = 'Medical Conference 2023';

UPDATE leads_db
SET lead_source = 'event'
WHERE lead_source IN ('trade show', 'CDC Conference 2024', 'FDB Conference 2023', 'Tech Expo 2024', 'Medical Conference 2024', 'Tech Expo 2023', 'Medical Conference 2023');
