...
SELECT
    CASE WHEN lead_source IN ('trade show', 'CDC Conference 2024', 'FDB Conference 2023', 'Tech Expo 2024', 'Medical Conference 2024', 'Tech Expo 2023', 'Medical Conference 2023', 'conference') THEN 'event'
         ELSE lead_source
    END AS 'Lead Source',
...
GROUP BY
    CASE
	WHEN lead_source IN ('trade show', 'CDC Conference 2024', 'FDB Conference 2023', 'Tech Expo 2024', 'Medical Conference 2024', 'Tech Expo 2023', 'Medical Conference 2023', 'conference') THEN 'event'
	ELSE lead_source
    END
ORDER BY COUNT(*) DESC;
